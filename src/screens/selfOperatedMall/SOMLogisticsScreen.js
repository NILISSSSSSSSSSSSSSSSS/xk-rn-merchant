...
class SOMLogisticsScreen extends PureComponent {
    ...
    getNavigaionParam = () => {
        ...
        const orderDdata = navigation.getParam('orderDdata', {})
        console.log('orderDdata', orderDdata)
        this.getLogistics(orderDdata)
        this.setState({
            orderDdata,
        })
    }
    ...
    getLogistics = (orderData) => {
        ...
        requestApi.logisticsQuery(params).then(res => {
            console.log('查询的物流信息',res)
            this.setState({
    ...
    render() {
        ...
        console.log('logisticsData',orderDdata)
        return (
                                            ...
                                            <View style={styles.flex_1}>
                                                {
                                                    ...
                                                    <View style={[styles.flex_start, styles.carIconView]}>
                                                        ...
                                                        <Text style={[styles.refundInfoProcessActiveText, { paddingLeft: 5 }]}>{orderDdata.orderStatus === 'PRE_SHIP' ? '运送中' : '待收货'}</Text>
                                                    </View>
                                                }
