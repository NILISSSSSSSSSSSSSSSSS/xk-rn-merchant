...
class ResetPasswordScreen extends PureComponent {
    ...
    confirm = () => {
        ...
        Loading.show()
        requestApi.mUserUpdatePassword({ phone, newPassword: password, reNewPassword: password, code, }).then(()=>{
            ...
            CustomAlert.onShow(
                ...
                () => {
                    ...
                    NavigatorService.reset('Login', { pageFrom: "ResetPasswordScreen" })
                },
                () => {},
                botton1Text = "确定",
            )
    ...
    _checkBtn = () => {
        ...
        if (!regular.phone(phone)) {
            ...
            Loading.show();
            requestApi.sendAuthMessage({ phone, bizType: 'RESET_PASSWORD' }).then(() => {
