...
class WMExpenseWaitOpenOrderDetail extends PureComponent {
    ...
    getOrderStatus = (data) => {
      ...
      if (data.drawType !== 'bymember') {
        const expectTime = moment(data.expectDrawTime * 1000).format('YYYY-MM-DD HH:mm');
    ...
    getTopOrderStatusLabel = (label = '', value = moment(), wrapStyle = {}, showText = '') => {
      ...
      return (
        <View style={[CommonStyles.flex_start,CommonStyles.flex_1, wrapStyle]}>
    ...
    getBottomItem = () => {
      ...
      return (
        <React.Fragment>
          <View
            style={[styles.flexStart, styles.flex_1, styles.btmLabelWrap]}
          >
            <Text style={styles.btmLabel}>期数：</Text>
            <Text style={[styles.btmLabel, styles.bottomValueStyle]}>{(orderData.currentNper < 10) ? `第0${orderData.currentNper}期` : `第${orderData.currentNper}期`}</Text>
          </View>
          <View
            style={[styles.flexStart, styles.flex_1, styles.btmLabelWrap]}
          >
          ...
          >
            ...
            <Text style={[styles.btmLabel, styles.bottomValueStyle]}>{moment(orderData.createdAt * 1000).format('YYYY-MM-DD HH:mm')}</Text>
          </View>
          <View
            style={[styles.flexStart, styles.flex_1, styles.btmLabelWrap]}
          >
            <Text style={styles.btmLabel}>兑奖方式：</Text>
            <Text style={[styles.btmLabel, styles.bottomValueStyle]}>抽奖券抽奖</Text>
          </View>
        </React.Fragment>
      );
    };
    ...
    getCrashNumItem = (label = '', value = '', index) => (
      <View
        key={index}
        style={[styles.flexStart, styles.flex_1, styles.crashLabelWrap]}
      >
        <Text style={styles.crashLabel}>{label}</Text>
        <Text style={[styles.crashLabel, { fontSize: 14, color: '#222' }]}>
          {value}
        </Text>
      </View>
    );
    ...
    render() {
      ...
      const time = moment((orderData.expectDrawTime || moment().format('MM-DD HH:mm')) * 1000).format('MM-DD HH:mm');
      ...
      console.log('orderData', orderData);
      const price = math.divide(orderData.price , 100) ;
      ...
      return (
        <View style={styles.container}>
          ...
          >
            ...
            <View style={[styles.goodsWrap, { marginTop: 10 }]}>
          ...
          <View style={styles.bottomBar}>
            ...
            >
              <View style={[styles.cunstomTextWrap, CommonStyles.flexCenter]}>
                <Text style={{
                  color: '#555', fontSize: 12, height: 22, lineHeight: 20, textAlign: 'center',
                }}
                >
                    联系客服
                </Text>
