...
import { FlatList, PanResponder, findNodeHandle, UIManager, Animated, View, Image,StyleSheet } from 'react-native';
/**
 * 排序列表
 */
class OrderFlatList extends React.Component {
        ...
        >
          {
            ...
            this.props.renderItemOtherView?this.props.renderItemOtherView({ item, index }):null
          }
        </Animated.View>
      </View>
    );
  ...
  render() {
    ...
    if (this.props.isOrder) {
      move =
        <View
          style={[styles.move, { width: this.props.orderWidth,left:0 }]}
