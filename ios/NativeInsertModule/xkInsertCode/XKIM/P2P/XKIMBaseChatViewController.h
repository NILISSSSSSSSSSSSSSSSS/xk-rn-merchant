...
/**
    ...
    p2p单聊采用XKIMBaseChatViewController
...
@class XKIMBaseChatViewController;

@protocol XKIMMultipleSelectionDelegate <NSObject>
...
@interface XKIMBaseChatViewController : BaseViewController<NIMSessionInteractorDelegate,NIMInputActionDelegate,NIMMessageCellDelegate,NIMChatManagerDelegate,NIMConversationManagerDelegate>

@property (nonatomic, strong)  UITableView *tableView;

@property (nonatomic, strong)  XKIMBaseChatInputView *sessionInputView;

@property (nonatomic, strong)  NIMSession *session;

@property (nonatomic, strong)  NIMMessage *searchMessage;//查询消息 用于从历史跳转过来
/**
 *  当前当初的菜单所关联的消息
 *
...
@property (nonatomic, weak) id<XKIMMultipleSelectionDelegate> multipleSelectionDelegate;
