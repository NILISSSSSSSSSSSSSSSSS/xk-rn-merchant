//
//  XKMineCouponPackageTerminalCardTableViewCell.m
//  XKSquare
//
...
@interface XKMineCouponPackageTerminalCardTableViewCell ()
...
@property (nonatomic, strong) UILabel *terminalNameLabel;
...
@implementation XKMineCouponPackageTerminalCardTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    discountNumLabel.textColor = [UIColor whiteColor];
    ...
    discountUnitLabel.textColor = [UIColor whiteColor];
    ...
    // 商户卡商户名
    UILabel *terminalNameLabel = [UILabel new];
    terminalNameLabel.textColor = [UIColor whiteColor];
    terminalNameLabel.font = [UIFont fontWithName:XK_PingFangSC_Regular size:12.0];
    [cardView addSubview:terminalNameLabel];
    [terminalNameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel.mas_bottom).offset(18);
        make.left.equalTo(titleLabel.mas_left);
    }];
    self.terminalNameLabel = terminalNameLabel;
    ...
    [dateLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(terminalNameLabel.mas_bottom).offset(2);
        make.left.equalTo(titleLabel.mas_left);
    }];
...
- (void)configCellWithModel:(XKMineCouponPackageCardItem *)cardItem {
    ...
    self.cardView.image = [UIImage imageNamed:@"xk_bg_terminal_card"];
    ...
    self.terminalNameLabel.text = [NSString stringWithFormat:@"%@", cardItem.storeName];
...
- (void)configOverdueCellWithModel:(XKMineCouponPackageCardItem *)cardItem {
    ...
    self.cardView.image = [UIImage imageNamed:@"xk_bg_overdue_terminal_card"];
    self.titleLabel.textColor = [UIColor whiteColor];
    self.selectButton.selected = cardItem.isSelected;
    NSString *titleLabel;
    if ([cardItem.cardType isEqualToString:@"VIP"]) {
...
- (void)clickSelectButton:(UIButton *)sender {
    ...
    [self.delegate terminalCardTableViewCell:self updateModel:self.cardItem];
}
