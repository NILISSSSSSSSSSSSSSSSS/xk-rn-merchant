//
//  XKWelfareCollectionDoubleProgressAndTimeCell.m
//  XKSquare
//
...
@interface XKWelfareCollectionDoubleProgressAndTimeCell ()
...
@implementation XKWelfareCollectionDoubleProgressAndTimeCell
- (void)createUI {
    [super createUI];
