//
//  XKWelfareCollectionDoubleProgressOrTimeCell.m
//  XKSquare
//
...
@interface XKWelfareCollectionDoubleProgressOrTimeCell ()
...
@end
@implementation XKWelfareCollectionDoubleProgressOrTimeCell
- (void)createUI {
    [super createUI];
...
- (void)layout {
    ...
    [self.timeBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.right.equalTo(self.bgContainView);
        make.top.equalTo(self.progressBgView.mas_bottom).offset(3);
        make.height.mas_equalTo(28);
    }];
