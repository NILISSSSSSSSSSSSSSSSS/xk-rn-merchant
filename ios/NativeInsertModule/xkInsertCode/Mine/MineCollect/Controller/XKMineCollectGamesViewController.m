///*******************************************************************************
// # File        : XKMineCollectGamesViewController.m
// # Project     : XKSquare
// # Author      : Lin Li
// # Created     : 2018/9/7
// # Corporation : 水木科技
...
//
//@interface XKMineCollectGamesViewController ()<UITableViewDelegate,UITableViewDataSource,XKCustomShareViewDelegate>{
//    BOOL _neverRequest;
//}
...
//@end
//
//@implementation XKMineCollectGamesViewController
...
//    // 初始化默认数据
//    _neverRequest = YES;
//    _model = [[XKCollectGamesModelDataItem alloc]init];
//    self.listTitle = @"全部分类";
//    [self initData];
//    [self hideNavigation];
//}
...
//            
//        }else{
//        [self.viewModel gamesRequestClassifyComplete:^(NSString * error, NSArray *array) {
...
//        [_tableView registerClass:[XKMineCollectGamesTableViewCell class] forCellReuseIdentifier:@"cell"];
...
//            for (XKCollectGamesModelDataItem *model in ws.viewModel.dataArray) {
...
//    if (!_viewModel) {
//        if (self.controllerType == XKBrowseControllerType){
//            _viewModel = [[XKCollectViewModel alloc]initWithViewModelType:XKCollectGamesViewModelType XKControllerType:XKBrowseControllerType];
//        }else {
//            _viewModel = [[XKCollectViewModel alloc]initWithViewModelType:XKCollectGamesViewModelType XKControllerType:XKCollectControllerCollectType];
//        }
//    }
//    return _viewModel;
//}
...
//    XKMineCollectGamesTableViewCell *cell = [tableView  dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
//    cell.xk_radius = 5;
...
//            
//        }else {
//            XKGamesDetailViewController *vc = [XKGamesDetailViewController new];
//            [self.navigationController pushViewController:vc animated:YES];
//        }
//    };
//    cell.shareBlock = ^(XKCollectGamesModelDataItem *model) {
//        XKGamesShareView *view = [[XKGamesShareView alloc]init];
//        view.model = model;
//        ws.model = model;
...
//        shareData.content = ws.model.target.describe;
...
//        [ws dealSelected];
//    };
//    cell.sendChoseblock = ^(XKCollectGamesModelDataItem *model) {
...
//    XKWeakSelf(ws);
//    NSMutableArray *deleteArray = [NSMutableArray array];
//    for (XKCollectGamesModelDataItem *model in self.viewModel.dataArray) {
//        if (model.isSelected == YES) {
//            [deleteArray addObject:model.ID];
//        }
//    }
...
//        for (XKCollectGamesModelDataItem *model in array) {
//            if (model.isSelected == YES) {
...
//        url = @"user/ua/xkFavoriteDelete/1.0";
//    }
//    XKCollectGamesModelDataItem *model = self.viewModel.dataArray[indexPath.row];
