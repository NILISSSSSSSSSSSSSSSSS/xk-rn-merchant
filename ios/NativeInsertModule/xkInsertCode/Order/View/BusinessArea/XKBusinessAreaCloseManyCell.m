...
@interface XKBusinessAreaCloseManyCell () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation XKBusinessAreaCloseManyCell
