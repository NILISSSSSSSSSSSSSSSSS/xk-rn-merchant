//
//  XKBusinessAreaEvaluateManyCell.m
//  XKSquare
//
...
@interface XKBusinessAreaEvaluateManyCell () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation XKBusinessAreaEvaluateManyCell
...
- (void)addCustomSubviews {
    ...
    [self.bgContainView addSubview:self.evaluateBtn];
}
...
- (void)evaluateBtnClick:(UIButton *)sender {
    if(self.evaluateBtnBlock) {
        self.evaluateBtnBlock(sender,nil);
    }
}
...
- (UIButton *)evaluateBtn {
    if(!_evaluateBtn) {
        ...
        _evaluateBtn.layer.cornerRadius = 10.f;
        ...
        [_evaluateBtn setBackgroundColor:[UIColor whiteColor]];
