//
//  XKMallOrderWaitEvaluateManyCell.m
//  XKSquare
//
...
@interface XKMallOrderWaitEvaluateManyCell () <UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation XKMallOrderWaitEvaluateManyCell
...
- (void)tipBtnClick:(UIButton *)sender {
    ...
    if(self.evaluateBtnBlock) {
        self.evaluateBtnBlock(sender, ws.item.index);
    }
}
...
- (UIButton *)tipBtn {
    if(!_tipBtn) {
        ...
        [_tipBtn setTitle:@"评价" forState:0];
