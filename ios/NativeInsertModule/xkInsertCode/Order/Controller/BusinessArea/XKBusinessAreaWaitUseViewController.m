//
//  XKBusinessAreaWaitUseViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaWaitUseSingleCell.h"
#import "XKBusinessAreaWaitUseManyCell.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"

@interface XKBusinessAreaWaitUseViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaWaitUseViewController
...
- (void)requestDataWithTips:(BOOL)tip {
    ...
    [XKSquareTradingAreaTool tradingAreaOrderList:muDic orderType:MOT_USE success:^(NSArray<AreaOrderListModel *> *list) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaWaitUseManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaWaitUseManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        ...
        XKBusinessAreaWaitUseSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaWaitUseSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    }
}
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaWaitUseSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaWaitUseSingleCell"];
        [_tableView registerClass:[XKBusinessAreaWaitUseManyCell class] forCellReuseIdentifier:@"XKBusinessAreaWaitUseManyCell"];
        XKWeakSelf(ws);
