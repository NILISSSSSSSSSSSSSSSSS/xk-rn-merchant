//
//  XKBusinessAreaPrepareViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaPrepareSingleCell.h"
#import "XKBusinessAreaPrepareManyCell.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"


@interface XKBusinessAreaPrepareViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaPrepareViewController
...
- (void)requestDataWithTips:(BOOL)tip {
    ...
    [XKSquareTradingAreaTool tradingAreaOrderList:muDic orderType:MOT_PREPARE success:^(NSArray<AreaOrderListModel *> *list) {
...
//    XKWeakSelf(weakSelf);
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaPrepareManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaPrepareManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    } else {
        XKBusinessAreaPrepareSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaPrepareSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    }
}
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaPrepareSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaPrepareSingleCell"];
        [_tableView registerClass:[XKBusinessAreaPrepareManyCell class] forCellReuseIdentifier:@"XKBusinessAreaPrepareManyCell"];
        XKWeakSelf(ws);
