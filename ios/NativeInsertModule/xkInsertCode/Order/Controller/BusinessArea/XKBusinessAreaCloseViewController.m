//
//  XKBusinessAreaCloseViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaCloseManyCell.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"

@interface XKBusinessAreaCloseViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaCloseViewController
...
- (void)requestDataWithTips:(BOOL)tip {
    ...
    [XKSquareTradingAreaTool tradingAreaOrderList:muDic orderType:MOT_CLOSED success:^(NSArray<AreaOrderListModel *> *list) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaCloseManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaCloseManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    } else {
        XKBusinessAreaCloseSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaCloseSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    }
}
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaCloseSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaCloseSingleCell"];
        [_tableView registerClass:[XKBusinessAreaCloseManyCell class] forCellReuseIdentifier:@"XKBusinessAreaCloseManyCell"];
        XKWeakSelf(ws);
