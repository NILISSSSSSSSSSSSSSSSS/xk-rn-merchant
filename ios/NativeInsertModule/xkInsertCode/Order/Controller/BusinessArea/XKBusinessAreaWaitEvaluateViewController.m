//
//  XKBusinessAreaWaitEvaluateViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaEvaluateSingleCell.h"
#import "XKBusinessAreaEvaluateManyCell.h"
#import "XKAlertView.h"
#import "XKPayAlertSheetView.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"

@interface XKBusinessAreaWaitEvaluateViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaWaitEvaluateViewController
...
- (void)requestDataWithTips:(BOOL)tip {
    ...
    [XKSquareTradingAreaTool tradingAreaOrderList:muDic orderType:MOT_EVALUATE success:^(NSArray<AreaOrderListModel *> *list) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaEvaluateManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaEvaluateManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        ...
        XKBusinessAreaEvaluateSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaEvaluateSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        cell.evaluateBtnBlock = ^(UIButton *sender,NSIndexPath *index) {
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaEvaluateSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaEvaluateSingleCell"];
        [_tableView registerClass:[XKBusinessAreaEvaluateManyCell class] forCellReuseIdentifier:@"XKBusinessAreaEvaluateManyCell"];
        XKWeakSelf(ws);
