//
//  XKBusinessAreaRefundViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaRefundManyCell.h"
#import "XKBusinessAreaRefundSingleCell.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"

@interface XKBusinessAreaRefundViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaRefundViewController
...
//    [XKSquareTradingAreaTool tradingAreaRefundOrderList:muDic success:^(NSArray<AreaOrderListModel *> *list) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaRefundManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaRefundManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    } else {
        XKBusinessAreaRefundSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaRefundSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    }
}
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaRefundSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaRefundSingleCell"];
        [_tableView registerClass:[XKBusinessAreaRefundManyCell class] forCellReuseIdentifier:@"XKBusinessAreaRefundManyCell"];
        XKWeakSelf(ws);
