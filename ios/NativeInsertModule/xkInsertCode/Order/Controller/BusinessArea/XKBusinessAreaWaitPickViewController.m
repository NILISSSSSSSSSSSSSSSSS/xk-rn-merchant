//
//  XKBusinessAreaWaitPickViewController.m
//  XKSquare
//
...
#import "XKBusinessAreaWaitPickSingleCell.h"
#import "XKBusinessAreaWaitPickManyCell.h"
#import "XKSquareTradingAreaTool.h"
#import "XKBusinessAreaOrderListModel.h"

@interface XKBusinessAreaWaitPickViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKBusinessAreaWaitPickViewController
...
- (void)requestDataWithTips:(BOOL)tip {
    ...
    [XKSquareTradingAreaTool tradingAreaOrderList:muDic orderType:MOT_PICK success:^(NSArray<AreaOrderListModel *> *list) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(item.goods.count > 1) {
        XKBusinessAreaWaitPickManyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaWaitPickManyCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
        
    } else {
        XKBusinessAreaWaitPickSingleCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKBusinessAreaWaitPickSingleCell" forIndexPath:indexPath];
        [cell bindData:item];
        return cell;
    }
}
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKBusinessAreaWaitPickSingleCell class] forCellReuseIdentifier:@"XKBusinessAreaWaitPickSingleCell"];
        [_tableView registerClass:[XKBusinessAreaWaitPickManyCell class] forCellReuseIdentifier:@"XKBusinessAreaWaitPickManyCell"];
        XKWeakSelf(ws);
