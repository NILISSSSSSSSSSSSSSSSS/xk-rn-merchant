//
//  XKMallTradeFinishViewController.m
//  XKSquare
//
...
@interface XKMallTradeFinishViewController ()
/*导航栏*/
...
@implementation XKMallTradeFinishViewController
...
- (UIButton *)evaluateBtn {
    if(!_evaluateBtn) {
        ...
        [_evaluateBtn setTitle:@"立即评价" forState:0];
