//
//  XKMallOrderRefundWaitSendViewController.m
//  XKSquare
//
...
@interface XKMallOrderRefundWaitSendViewController ()<UITableViewDelegate, UITableViewDataSource,UITextFieldDelegate>
/*导航栏*/
...
@implementation XKMallOrderRefundWaitSendViewController
...
- (void)handleData {
    [super handleData];
    for (MallOrderListObj *obj in self.item.goods) {
