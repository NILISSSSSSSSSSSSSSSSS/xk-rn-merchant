//
//  XKMallOrderDetailWaitEvaluateViewController.m
//  XKSquare
//
...
@interface XKMallOrderDetailWaitEvaluateViewController () <UITableViewDelegate,UITableViewDataSource>
...
@implementation XKMallOrderDetailWaitEvaluateViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    switch (indexPath.section) {
        case 0:
        {
            ...
            [cell handleOrderDetailWithType:MOT_PRE_EVALUATE dataModel:_viewModel];
            return cell;
        }
            break;
        case 1:
        ...
        case 3:
        {
            XKMallOrderDetailWaitEvaluateInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKMallOrderDetailWaitEvaluateInfoCell" forIndexPath:indexPath];
        ...
        {
            XKMallOrderDetailWaitEvaluateInfoCell *cell = [tableView dequeueReusableCellWithIdentifier:@"XKMallOrderDetailWaitEvaluateInfoCell" forIndexPath:indexPath];
            [cell handleWaitPayOrderDetailModel:_viewModel withType:3];
            return cell;
        }
            break;
        case 7:
...
- (UITableView *)tableView {
    if(!_tableView) {
        ...
        [_tableView registerClass:[XKMallOrderDetailWaitEvaluateInfoCell class] forCellReuseIdentifier:@"XKMallOrderDetailWaitEvaluateInfoCell"];
...
- (XKMallOrderListBottomView *)bottomView {
    if(!_bottomView) {
        XKWeakSelf(ws);
        _bottomView = [XKMallOrderListBottomView MallOrderListBottomViewWithType:MallOrderDetailWaitEvaluate];
        ...
        _bottomView.evaluateBlock = ^(UIButton *sender) {
            XKOrderEvaluationController *evaluate = [XKOrderEvaluationController new];
            evaluate.evaluationType = XKEvaluationTypeMallDetail;
            evaluate.item = ws.viewModel;
            [[ws getCurrentUIVC].navigationController pushViewController:evaluate animated:YES];
        };
    }
    return _bottomView;
}
