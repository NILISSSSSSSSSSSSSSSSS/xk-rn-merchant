//
//  XKTradingAreaGoodsDetailChooseSpecificationView.m
//  XKSquare
//
...
@interface XKTradingAreaGoodsDetailChooseSpecificationView ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation XKTradingAreaGoodsDetailChooseSpecificationView
...
//        make.left.equalTo(self.imgView.mas_left);
//        make.top.equalTo(self.lineView1.mas_bottom).offset(16);
//        make.width.equalTo(@30);
//    }];
    
    [self.collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.left.equalTo(self.guigeLabel.mas_right).offset(10);
//        make.centerY.equalTo(self.guigeLabel);
        make.left.equalTo(self.imgView.mas_left);
        make.right.equalTo(self).offset(-15);
    ...
    [self.lineView2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.height.equalTo(@1);
//        make.top.equalTo(self.guigeLabel.mas_bottom).offset(16);
...
- (UIButton *)sureButton {
    if (!_sureButton) {
        ...
        [_sureButton addTarget:self action:@selector(addCarBtnClicked:) forControlEvents:UIControlEventTouchUpInside];
    }
    return _sureButton;
}
