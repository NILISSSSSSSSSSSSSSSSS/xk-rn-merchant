...
@interface XKMallBuyCarListBottomView ()
/**全选/反选*/
...
@implementation XKMallBuyCarListBottomView
...
- (UIButton *)choseBtn {
    if(!_choseBtn) {
        ...
        CGFloat w = [@"全选" boundingRectWithSize:CGSizeMake(MAXFLOAT, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName : XKRegularFont(14)} context:nil].size.width;
        _choseBtn.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, 10);
