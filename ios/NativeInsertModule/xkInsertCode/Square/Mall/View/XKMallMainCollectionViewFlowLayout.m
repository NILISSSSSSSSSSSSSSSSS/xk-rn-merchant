...
@interface XKMallMainCollectionViewFlowLayoutAttributes  : UICollectionViewLayoutAttributes
// 背景色
@property (nonatomic, strong) UIColor *backgroudColor;

@end

@implementation XKMallMainCollectionViewFlowLayoutAttributes
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes{
    ...
    XKMallMainCollectionViewFlowLayoutAttributes *attr = (XKMallMainCollectionViewFlowLayoutAttributes *)layoutAttributes;
...
@interface XKMallMainCollectionViewFlowLayout  ()
...
@implementation XKMallMainCollectionViewFlowLayout

- (void)prepareLayout{
    [super prepareLayout];
    
    NSInteger sections = [self.collectionView numberOfSections];
    id<XKMallMainCollectionViewFlowLayout> delegate  = self.collectionView.delegate;
    ...
    for (NSInteger section =0; section < sections; section++) {
        ...
        if (numberOfItems > 0) {
            ...
            //2. 定义
            XKMallMainCollectionViewFlowLayoutAttributes *attr = [XKMallMainCollectionViewFlowLayoutAttributes layoutAttributesForDecorationViewOfKind:ULBCollectionViewSectionColor withIndexPath:[NSIndexPath indexPathForRow:0 inSection:section]];
