//
//  XKWelfareListSingleProgressCell.m
//  XKSquare
//
...
@interface XKWelfareListSingleProgressCell ()
...
@implementation XKWelfareListSingleProgressCell
...
- (void)addUIConstraint {
    ...
    [self.progressBgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.bgContainView.mas_bottom).offset(-20);
