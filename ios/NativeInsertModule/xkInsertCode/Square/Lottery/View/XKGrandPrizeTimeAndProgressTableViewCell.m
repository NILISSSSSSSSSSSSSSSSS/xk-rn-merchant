//
//  XKGrandPrizeTimeAndProgressTableViewCell.m
//  XKSquare
//
...
@interface XKGrandPrizeTimeAndProgressTableViewCell ()
...
@implementation XKGrandPrizeTimeAndProgressTableViewCell
...
- (void)initializeViews {
    ...
    [self.statusView addSubview:self.progressLab];
    [self.statusView addSubview:self.progressBar];
    [self.statusView addSubview:self.progressValueLab];
    [self.statusView addSubview:self.timeLab];
...
- (void)updateViews {
    ...
    [self.detailBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.statusView.mas_bottom).offset(8.0);
...
- (UIView *)statusView {
    if (!_statusView) {
        ...
        _statusView.backgroundColor = HEX_RGB(0xF0F6FF);
    }
    return _statusView;
}
