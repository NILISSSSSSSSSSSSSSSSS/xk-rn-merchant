//
//  XKActivityTicketTableViewCell.m
//  XKSquare
//
...
@interface XKActivityTicketTableViewCell ()
...
@implementation XKActivityTicketTableViewCell
...
- (void)initializeViews {
    ...
    self.leftImgView.image = IMG_NAME(@"xk_img_activityTicker_left");
    ...
    self.moreImgView.image = IMG_NAME(@"xk_img_activityTicker_more");
    [self.leftImgView addSubview:self.moreImgView];
    
    self.rightImgView = [[UIImageView alloc] init];
    self.rightImgView.image = IMG_NAME(@"xk_img_activityTicker_right");
    ...
    self.ticketNameLab.textColor = HEX_RGB(0xEC725E);
    ...
    self.remarkLab.textColor = HEX_RGB(0xEC725E);
...
- (void)updateViews {
    ...
    [self.leftImgView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.mas_equalTo(self.leftImgView.mas_height).multipliedBy(77 / 100.0);
    }];
