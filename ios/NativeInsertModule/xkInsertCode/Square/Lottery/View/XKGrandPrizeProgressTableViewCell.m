//
//  XKGrandPrizeProgressTableViewCell.m
//  XKSquare
//
...
@interface XKGrandPrizeProgressTableViewCell ()
...
@implementation XKGrandPrizeProgressTableViewCell
...
- (void)updateViews {
    ...
    [self.detailBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.progressView.mas_bottom).offset(8.0);
